...
/**
* Updated for using WP Editor in BP profile edit textarea; code around line 2313-2317.
...
class BP_XProfile_Field_Type_Textarea extends BP_XProfile_Field_Type {
	...
	?>
		...
		<!--Below code replaces buddypress textarea with WP Editor -->
<?php
	$args = array("textarea_rows" => 5, "textarea_name" => "field_2", "editor_class" => "my_editor_custom");
	$values = bp_get_the_profile_field_edit_value();
wp_editor($values, "field_2", $args);
	?>	
